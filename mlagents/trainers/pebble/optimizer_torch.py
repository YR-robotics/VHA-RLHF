...
class PEBBLESettings(OffPolicyHyperparamSettings):
    batch_size: int = 128
...
class TorchPEBBLEOptimizer(TorchOptimizer):
    ...
    def __init__(self, policy: TorchPolicy, trainer_settings: TrainerSettings):
        ...
        hyperparameters: PEBBLESettings = cast(
            PEBBLESettings, trainer_settings.hyperparameters
        )
        ...
        self.q_network = TorchPEBBLEOptimizer.PolicyValueNetwork(
            self.stream_names,
        ...
        self._log_ent_coef = TorchPEBBLEOptimizer.LogEntCoef(
        ...
        self.target_entropy = TorchPEBBLEOptimizer.TargetEntropy(
    ...
    def update(self, batch: AgentBuffer, num_sequences: int) -> Dict[str, float]:
        ...
        for name in self.reward_signals:
            ...
            # print("rewards[name]", rewards[name])
        rewards2 = rewards
        ...
        return update_stats, current_obs2, next_obs2, actions2, rewards2, dones2
    def update_state_ent(self, batch_all: AgentBuffer, batch_size=1024 , gradient_update=1, K=5, normalize_state_entropy = True, tail_=500) -> Dict[str, float]:
        """
        Updates model using buffer RANDOM from start to tail.
        :param num_sequences: Number of trajectories in batch.
        :param batch: Experience mini-batch.
        :param update_target: Whether or not to update target value network
        :param reward_signal_batches: Minibatches to use for updating the reward signals,
        ...
        # print("batch.num_experiences", batch.num_experiences)
        # print("idxs", [len(t) for t in current_obs_cut])
