...
from mlagents.trainers.trainer.off_policy_trainer_PEBBLE import OffPolicyTrainer_R
from mlagents.trainers.policy.torch_policy import TorchPolicy
from mlagents.trainers.policy.policy import Policy
from mlagents.trainers.pebble.optimizer_torch import TorchPEBBLEOptimizer, PEBBLESettings
...
TRAINER_NAME = "pebble"
class PEBBLETrainer(OffPolicyTrainer_R):
    """
    The pebble is an implementation of the pebble algorithm, with support
    ...
    def __init__(
        ...
        self.optimizer: TorchPEBBLEOptimizer = None  # type: ignore
        self.hyperparameters: PEBBLESettings = cast(
    ...
    def create_optimizer(self) -> TorchOptimizer:
        return TorchPEBBLEOptimizer(  # type: ignore
    ...
    def create_policy(
        ...
        :return policy
        """
        actor_cls = SimpleActor_R
        actor_kwargs = {"conditional_sigma": True, "tanh_squash": True}
        # workspace = Workspace(behavior_spec)
        policy = TorchPolicy(
            self.seed,
            behavior_spec,
