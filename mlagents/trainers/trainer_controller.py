...
class TrainerController:
    ...
    def _create_trainer_and_manager(
        ...
        # print("behavior_spec.observation_specs[i].shape")
        # for i in range(len(behavior_spec.observation_specs)):
        #     print(behavior_spec.observation_specs[i].shape)
        policy = trainer.create_policy(
            parsed_behavior_id,
            env_manager.training_behaviors[name_behavior_id],
        )
        # print("add_policy:",parsed_behavior_id)
    ...
    def advance(self, env_manager: EnvManager) -> int:
        ...
        with hierarchical_timer("env_step"):
            ...
            # experience experience buffer trajectory trajectory_queue
