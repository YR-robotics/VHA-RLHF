...
from mlagents.trainers.pebble.trainer import PEBBLETrainer
...
from mlagents.trainers.pebble.optimizer_torch import PEBBLESettings
    ...
    mla_plugins.all_trainer_types.update(
        {
            ...
            PEBBLETrainer.get_trainer_name(): PEBBLETrainer,
        }
    )
    ...
    mla_plugins.all_trainer_settings.update(
        {
            ...
            PEBBLETrainer.get_trainer_name():PEBBLESettings,
        }
    )
